...
class Category extends Model {
	...
	public function save()
	{
		...
		$results = $sql->select("CALL sp_categories_save(:idcategory, :descatedory)", array(
			":idcategory"=>$this->getidcategory(),
			":descatedory"=>$this->getdescategory()
		));
	...
	public function getPrductsPage($page = 1, $itemsPerPage = 8)
	{
